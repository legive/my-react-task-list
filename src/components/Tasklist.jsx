...
export default function Tasklist () {
  ...
  return (
    ...
    <form>
        ...
        <button  style={{backgroundColor:'purple'}}><BsPlusCircleFill/></button> 
...
<div key={tarea} className="contenedor">

<Task nombre={tarea.descripcion} estaCompletada={tarea.estaCompletada}/>
